    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 border-b border-border-subtle bg-white relative overflow-hidden group">
        ...
        <div className="flex items-baseline gap-2 mb-4 relative z-10">
          <span className="text-5xl font-bold text-text-main tracking-tighter">12</span>
          <span className="text-sm text-text-secondary font-bold uppercase">days</span>
        </div>
        <div className="relative z-10 space-y-2">
          <div className="flex justify-between items-end">
            <span className="text-[10px] font-mono text-text-secondary">NEXT: 14 DAYS</span>
            <span className="text-[10px] font-bold text-primary">85%</span>
          </div>
          <div className="w-full bg-[#f0f0f0] h-2 border border-[#f0f0f0]">
            <div className="bg-primary h-full w-[85%] relative overflow-hidden">
          ...
          <p className="text-[10px] text-text-secondary leading-tight pt-1">
            Maintain your streak for <span className="text-text-main font-bold">2 more days</span> to unlock the Fortnight badge.
          </p>
        </div>
      </div>
